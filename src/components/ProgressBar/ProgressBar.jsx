  ...
  return (
    <div className={style.ProgressBar}>
      <div className={style.inner_progressbar}>
        <div className={style.progressbar_text}>Работа - это просто FAQ</div>
        <div
          onClick={() => handleOnToggleMenu()}
          className={style.progressbar_toggle_button}
        >
      ...
      <div
        className={classNames(style.toggle_menu, isOpen ? null : style.hidden)}
      >
